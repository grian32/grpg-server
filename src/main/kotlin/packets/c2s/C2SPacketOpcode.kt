...
enum class C2SPacketOpcode(val opcode: Byte, val structure: Map<String, PacketType>, val packet: C2SPacket) {
    // basically a shim because i cant handle this normally lol
    LOGIN(0x01, C2SLoginPacket.STRUCTURE, C2SLoginPacket()),
    MOVE(0x02, C2SMovePacket.STRUCTURE, C2SMovePacket())
}